...
1. [Project objective and lab environment](00-project-overview.md)
2. [Phase 1 — Baseline](01-baseline.md)
3. [Phase 2 — Vulnerability Management](02-vulnerability-management.md)
4. [Phase 3 — Security Hardening](03-security-hardening.md)
...
The screenshots supporting these phases are cataloged in the [Evidence Index](EVIDENCE_INDEX.md).

I intentionally excluded raw working notes, duplicate screenshots, unsanitized internal addresses, and intermediate drafts from the publication set.
